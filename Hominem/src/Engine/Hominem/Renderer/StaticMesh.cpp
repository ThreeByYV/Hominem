...
namespace Hominem
{
        ...
        const Ref<Shader>& shader, const glm::mat4& actorTransform, const Frustum* frustum)
    {
        ...
        struct DrawCmd {
            ...
            uint32_t baseVertex;
            uint32_t baseInstance; // unused — we use gl_DrawID + u_BaseModelIndex instead
        };
        ...
        // Issue one glMultiDrawElementsIndirect per material batch.
        // u_BaseModelIndex tells the shader where in the SSBO this batch starts.
        // gl_DrawID (0,1,2...) indexes within the batch — no gl_BaseInstance needed.
        ...
        while (batchStart < total)
        {
            ...
            // Tell the shader where this batch starts in the SSBO.
